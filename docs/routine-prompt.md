...
**Image dans le corps de l'article, ajoutée le 10 août.** Si `use_topic_image.py` a produit `assets/social/topic-images/{AAAA-MM-JJ}-wide.jpg` (recadrage 16:9 de la même photo déjà validée — voir docstring du script), insérer un bloc image dans `index.html`, **entre `</nav>` (fin du sommaire `.toc`) et `<div class="question-box">`** :
```html
<figure class="article-image">
  <img src="assets/social/topic-images/{AAAA-MM-JJ}-wide.jpg" alt="{description factuelle courte de la photo}">
