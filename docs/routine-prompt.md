...
1. Ouvrir `sources-log.json` (racine du dépôt) — un objet par jour dans `"days"`. Ajouter un nouvel objet (ou compléter celui du jour s'il existe déjà) : `{"date": "AAAA-MM-JJ", "articles": [{"title", "source", "url", "lang" ("fr"/"en"/"other"), "domain" (un des 6 slugs de `docs/tags.md`), "summary", "read_minutes"}, ...]}`. `read_minutes` : estimation simple, pas la peine de chronométrer.
