...
**Restriction du 19 septembre 2026 : jamais un sujet centré sur un homme sans fonction institutionnelle.** Retour utilisateur explicite : une édition ne doit jamais avoir pour acteur central un homme, sauf s'il occupe une fonction institutionnelle de premier plan (président, pape, gouverneur ou équivalent) — objectif assumé, éviter de prêter le flanc à des rumeurs sur un homme qui n'a pas ce statut public. Déclencheur : l'édition du 19 septembre 2026 (Sheeran/Macklemore/Kraft) enfreignait cette règle — laissée telle quelle (déjà publiée), la restriction s'applique à partir de l'édition suivante. Ajoutée dans `docs/routine-prompt.md` § Étape 1, « Restrictions absolues », au même niveau que les restrictions déjà en place (fait divers violent, personne privée nommée, sujet à caractère sexuel, polémique sans enjeu factuel clair).
