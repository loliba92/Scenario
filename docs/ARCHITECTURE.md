...
moins prioritaire). **Backlog produit/éditorial (confiance/méthode, SEO,
participatif, mesure) tenu à part dans `docs/backlog-produit.md`** — ne
pas y dupliquer les entrées déjà présentes ici, y renvoyer par intitulé.
